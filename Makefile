cpp=g++ -O2 -w -masm=intel -finput-charset=utf-8
cpp11=g++ -O2 -std=c++11 -w -masm=intel -finput-charset=utf-8
cc=gcc -O2 -w -masm=intel -finput-charset=utf-8
cc11=gcc -O2 -std=c11 -w -masm=intel -finput-charset=utf-8
build_linux_amd64:
