...
const wchar_t invalid_install_path_en_us[]=L"(!)Invalid path,Please try again";
const wchar_t invalid_install_path_zh_hans[]=L"(!)无效的安装路径，请重试";
const wchar_t invalid_install_path_zh_hant[]=L"(!)無效的安裝路徑，請重試";
...
wchar_t *no;
wchar_t *installing;
wchar_t *installation_completed;
wchar_t *installation_failed;
wchar_t *errcode;
wchar_t invalid_install_path;
#endif